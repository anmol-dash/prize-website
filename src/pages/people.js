...
import MichaelCampos from "../images/2022/MichaelCampos.jpg"
import AsherGoldman from "../images/2022/AsherGoldman.jpg"
import BenThomas from "../images/2022/BenThomas.jpg"
import LydiaLi from "../images/2022/LydiaLi.jpg"
...
const KeynoteList = [
  {
    ...
    name: "Andrew Beebe",
    lastName: "Beebe",
    description:<>Managing Director @ <Link target="_blank" rel="noopener noreferrer" href="https://obvious.com/">Obvious Ventures</Link> </>,
  ...
  },
  {
    ...
    name: "Elaine Hsieh",
    lastName: "Hsieh",
    description:<>Co-Founder and Chief Marketing Officer @ <Link target="_blank" rel="noopener noreferrer" href="https://www.third-derivative.org/">Third Derivative</Link></>,
...
const JudgeList = [
  {
    ...
    lastName: "Papanikolopoulos",
    description: <>Founder and Creative Director @ <Link target="_blank" rel="noopener noreferrer" href="https://www.coimatan.com/">Coimatan</Link></>,
  ...
  },
  {
    ...
    name: "Katie Gardner",
    lastName: "Gardner",
    description: <>Product Manager @ <Link target="_blank" rel="noopener noreferrer" href="https://www.banyaninfrastructure.com/">Banyan Infrastructure</Link></>,
  ...
  },
  {
    ...
    name: "Raghav Poddar",
    lastName: "Poddar",
    description: <>CEO @ <Link target="_blank" rel="noopener noreferrer" href="https://www.forwardkitchens.com/">Forward Kitchens</Link></>,
  ...
  },
  {
    ...
    name: "Ryan Jeffrey",
    lastName: "Jeffrey",
    description: <>Managing Director of Sustainability @ <Link target="_blank" rel="noopener noreferrer" href="https://www.gener8tor.com/">gener8tor</Link></>,
  ...
  },
  {
    ...
    lastName: "Izikowitz",
    description: <>CEO @ <Link target="_blank" rel="noopener noreferrer" href="https://www.carboninfinity.com/">Carbon Infinity</Link></>,
  ...
  },
  {
    ...
    lastName: "Campos",
    description: <>Principle @ <Link target="_blank" rel="noopener noreferrer" href="https://www.azollaventures.com/">Azolla Ventures</Link></>,
  },
  {
    imageSrc: LydiaLi,
    imageAlt: "Lydia Li",
    name: "Lydia Li",
    lastName: "Li",
    description: <>VP of Investments @ <Link target="_blank" rel="noopener noreferrer" href="https://arevonenergy.com/">AREVON</Link></>,
  },
  {
    imageSrc: BenThomas,
    imageAlt: "Ben Thomas",
    name: "Ben Thomas",
    lastName: "Thomas",
    description: <>Associate Consultant @ <Link target="_blank" rel="noopener noreferrer" href="https://www.bain.com/">Bain & Company</Link></>,
  },
  {
    imageSrc: AsherGoldman,
    imageAlt: "Asher Goldman",
    name: "Asher Goldman",
    lastName: "Goldman",
    description: <>The Wharton School, @ <Link target="_blank" rel="noopener noreferrer" href="https://generatecapital.com/l">Generate Capital</Link></>,
  }
]
...
const MentorList = [
  {
    ...
    name: "Justin Heyman",
    lastName: "Heyman",
    description: <>Managing Director @ <Link target="_blank" rel="noopener noreferrer" href="https://www.springgp.com/">Spring Growth Partners</Link></>,
  ...
  },
  {
    ...
    name: "Eric Lee",
    lastName: "Lee",
    description: <>Vice President @ <Link target="_blank" rel="noopener noreferrer" href="https://www.alignedclimatecapital.com/">Aligned Climate Capital</Link></>,
  ...
  },
  {
    ...
    lastName: "Kriozere",
    description: <>Principal @ <Link target="_blank" rel="noopener noreferrer" href="https://www.joinc3.co/">C3</Link></>,
  ...
  },
  {
    ...
    lastName: "Tilvawala",
    description: <>Founder @ <Link target="_blank" rel="noopener noreferrer" href="https://youthcc.org/">Youth Climate Collaborative</Link>, Youth Engagement Manager @ <Link target="_blank" rel="noopener noreferrer" href="https://www.theclimateinitiative.org/">The Climate Initiative</Link></>,
  ...
  },
  {
    ...
    name: "Nicholas Yiu",
    lastName: "Yiu",
    description: <>Co-Founder @ <Link target="_blank" rel="noopener noreferrer" href="https://www.intercalation.co/">Intercalation</Link></>,
  ...
  },
  {
    ...
    name: "Roland Scott",
    lastName: "Scott",
    description: <>Principal and Co-Founder @ <Link target="_blank" rel="noopener noreferrer" href="https://www.cleanenergyanalytics.com/">Clean Energy Analytics</Link></>,
...
const mapPeople = peopleList => {
  peopleList.sort((a, b) => { return a.lastName.localeCompare(b.lastName) })
